...
list.append(29)
print("After appending 29 list is=",list)                                 #append fun will add max 2 number in the list                      

list.insert(5,35)
print("After inserting 35 list is=",list)                               #insert fun will insert a number in list
